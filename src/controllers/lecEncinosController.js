//Lecturas Los Encinos Controller
    ...
    createLectura: async (req, res) =>{
        ...
        try {
            ...
            await pool.request()
                ...
                .query(`
                    INSERT INTO LecturasLosEncinos (NumeroMedidor, Fecha, LecturaAnterior, LecturaActual, Consumo, Monto, FaltaAsamblea, MultaRetraso)
