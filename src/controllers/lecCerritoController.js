//Lecturas El Cerrito Controller
    ...
    createLectura: async (req, res) =>{
        ...
        try {
            ...
            await pool.request()
                ...
                .query(`
                    INSERT INTO LecturasElCerrito (NumeroMedidor, Fecha, LecturaAnterior, LecturaActual, Consumo, Monto, FaltaAsamblea, MultaRetraso)
